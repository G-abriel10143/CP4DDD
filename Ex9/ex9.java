 ...
 * Em seguida, para cada forma, pergunte se deseja criar um quadrado, um retângulo ou um círculo, 
 * solicitando os dados necessários para criar a forma. Todas as formas criadas devem ser armazenadas em um ArrayList próprio. 
 * Ao final, após cadastrar as formas, finalmente, 
 * imprima: (a) os dados (lados ou raio); (b) os perímetros; e (c) as áreas de todas as formas.
 */
