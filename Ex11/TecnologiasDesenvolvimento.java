...
/*
 * - Uma classe abstrata para representar as tecnologias de desenvolvimento. 
 * Seus atributos devem ser linguagem de programação, principal framework, 
 * descrição da linguagem e descrição do framework;
 */
